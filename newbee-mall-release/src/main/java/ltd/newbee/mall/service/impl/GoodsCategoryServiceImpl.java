...
public class GoodsCategoryServiceImpl implements GoodsCategoryService {
    ...
    public PageResult getCategoryPage(PageQueryUtil pageQueryUtil) {
        List<GoodsCategory> categoryList = goodsCategoryMapper.findCategoryList(pageQueryUtil);
        //总记录数
        int totalCategory = goodsCategoryMapper.getTotalGoodsCategory(pageQueryUtil);
        PageResult pageResult = new PageResult(categoryList, totalCategory, pageQueryUtil.getLimit(), pageQueryUtil.getPage());
        return pageResult;
    }
    ...
    public String saveCategory(GoodsCategory goodsCategory) {
        GoodsCategory gc1 = goodsCategoryMapper.selectByLevelAndName(goodsCategory.getCategoryLevel(), goodsCategory.getCategoryName());
        if (gc1 != null) {
    ...
    public String updateGoodsCategory(GoodsCategory goodsCategory) {
        GoodsCategory gc1 = goodsCategoryMapper.selectByPrimaryKey(goodsCategory.getCategoryId());
        if (gc1 == null) {
            return ServiceResultEnum.DATA_NOT_EXIST.getResult();
        }
        GoodsCategory gc2 = goodsCategoryMapper.selectByLevelAndName(goodsCategory.getCategoryLevel(), goodsCategory.getCategoryName());
        if (gc2 != null && gc2.getCategoryId().equals(goodsCategory.getCategoryId())) {
            //同名且不同id不能继续修改
            return ServiceResultEnum.SAME_CATEGORY_EXIST.getResult();
        }
