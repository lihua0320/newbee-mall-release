...
//        List<NewBeeMallShoppingCartItemVO> shoppingCartItems = shoppingCartService.getMyShoppingCartItems(user.getUserId());
////        System.out.println("456" + shoppingCartItems);
...
//        }
//        //保存订单并返回订单号
//        String saveOrderResult = newBeeMallOrderService.saveOrder(user, shoppingCartItems);
////        System.out.println(saveOrderResult + "11111");
//        //跳转到订单详情页
